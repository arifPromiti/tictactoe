                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="{{ url('/startNewGame/') }}" id="gameConfigForm" class="form-horizontal" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="subjectId">1st Player name</label>
                                                <input type="text" name="1stPlayer" id="1stPlayer" class="form-control" placeholder="Ex. Arif" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="fullMark">2nd Player name</label>
                                                <input type="text" name="2ndPlayer" id="2ndPlayer" class="form-control" placeholder="Ex. Rafiq" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
